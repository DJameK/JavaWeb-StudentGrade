...
<div class="container-fluid">
    <div class="row">
        ...
        <div class="col-sm-9 col-sm-offset-3 col-md-10 col-md-offset-2 main">
            <form class="form-signin" action="${pageContext.request.contextPath}/teacher/updateATeacher" method="post">
                <h1 class="page-header">修改教师信息</h1>
                <input type="hidden" name="t_pwd" class="form-control" value="${teacher.getT_pwd()}">
                <input type="hidden" name="t_id" value="${teacher.getT_id()}">
                学号:<input type="text" class="form-control"value="${teacher.getT_id()}" disabled="disabled" style="background:#CCCCCC">
                名字:<input type="text" name="t_name"  class="form-control" placeholder="${teacher.getT_name()}">
                手机:<input type="text" name="telephone" class="form-control" placeholder="${teacher.getTelephone()}">
                性别:
                <div class="radio">
