...
<div class="container-fluid">
    <div class="row">
        ...
        <div class="col-sm-9 col-sm-offset-3 col-md-10 col-md-offset-2 main">
            <h1 class="page-header">课程列表 —— 显示所有课程</h1>
            ...
            <div class="table-responsive">
                <table class="table table-striped">
                    ...
                    <tr>
                        ...
                        <th>学分</th>
                        <th>学时</th>
                        <th><a class="btn btn-primary" href="${pageContext.request.contextPath}/course/toAddCourse">新增</a></th>
                    </tr>
                    </thead>
                    <tbody>
                    <tr>
                    ...
                    <tr>
                        ...
                        <td>
                            <a href="${pageContext.request.contextPath}/course/toUpdateCourse/${course.getCourse_id()}">更改</a> |
                            <a href="${pageContext.request.contextPath}/course/del/${course.getCourse_id()}">删除</a>
                        </td>
                    </tr>
                    </c:forEach>
                    </tr>
