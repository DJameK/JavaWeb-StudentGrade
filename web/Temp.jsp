    ...
    <div class="row">
        <div class="col-sm-3 col-md-2 sidebar">
            <ul class="nav nav-sidebar">
                ...
                <li><a href="${pageContext.request.contextPath}/course/Student/${requestScope.get("Student").getStu_id()}">课程信息查询</a></li>
                <li> <a href="${pageContext.request.contextPath}/grade/Student/${requestScope.get("Student").getStu_id()}">查询课程成绩</a></li>
                <li> <a href="${pageContext.request.contextPath}/student/toUpdatePwd/${requestScope.get("Student").getStu_id()}">修改密码</a></li>

            </ul>
        </div>
        <div class="col-sm-9 col-sm-offset-3 col-md-10 col-md-offset-2 main">
            <h1 class="page-header">课程列表 —— 所有课程信息</h1>
