...
<div class="container-fluid">
    <div class="row">
        ...
        <div class="col-sm-9 col-sm-offset-3 col-md-10 col-md-offset-2 main">
            <form class="form-signin" action="${pageContext.request.contextPath}/student/updateAStudent" method="post">
                <h1 class="page-header">修改学生信息</h1>
                <input type="hidden" name="stu_id" value="${student.getStu_id()}">
                <input type="hidden" name="stu_pwd" value="${student.getStu_pwd()}">
                学号:<input type="text" name="stu_id" class="form-control"value="${student.getStu_id()}" disabled="disabled" style="background:#CCCCCC">
                名字:<input type="text" name="stu_name"  class="form-control" placeholder="${student.getStu_name()}">
                班级:<input type="text" name="class_name" class="form-control" placeholder="${student.getClass_name()}">
                手机:<input type="text" name="telephone" class="form-control" placeholder="${student.getTelephone()}">
                性别:
                <div class="radio">
                    <label><input type="radio" name="stu_gender" value="男" checked="true">男</label>
                    <label><input type="radio" name="stu_gender" value="女" >女</label>
                </div>
