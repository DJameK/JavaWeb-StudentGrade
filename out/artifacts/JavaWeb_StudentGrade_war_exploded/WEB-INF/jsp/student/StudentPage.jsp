...
<div class="container-fluid">
    <div class="row">
        ...
        <div class="col-sm-9 col-sm-offset-3 col-md-10 col-md-offset-2 main">
            <h1 class="page-header">欢迎你，${sessionScope.get("Student").getStu_name()}</h1>
            <h2>个人信息</h2>
            <h3> <span>学号:</span>${sessionScope.get("Student").getStu_id()}</h3>
            <h3> <span>性别:</span>${sessionScope.get("Student").getStu_gender()}</h3>
            <h3> <span>电话:</span>${sessionScope.get("Student").getTelephone()}</h3>
        </div>
    </div>
</div>
</body>
