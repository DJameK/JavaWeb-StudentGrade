...
<div class="container-fluid">
    <div class="row">
        ...
        <div class="col-sm-9 col-sm-offset-3 col-md-10 col-md-offset-2 main">
            <form class="form-signin" action="${pageContext.request.contextPath}/student/addAStudent" method="post">
                <h1 class="page-header">新增学生</h1>
                <input type="text" name="stu_id" class="form-control" placeholder="学号" required>
                <input type="text" name="stu_name" class="form-control" placeholder="名字"required>
                <input type="text" name="class_name" class="form-control" placeholder="班级" required>
                <input type="hidden" name="stu_pwd"  class="form-control" placeholder="00000000" required>
