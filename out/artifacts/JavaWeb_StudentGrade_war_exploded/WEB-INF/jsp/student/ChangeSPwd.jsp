    ...
    <div class="row">
        <div class="col-sm-3 col-md-2 sidebar">
            <ul class="nav nav-sidebar">
                <li class="active"><a href="${pageContext.request.contextPath}/student/MainPage">首页</a></li>
                <li><a href="${pageContext.request.contextPath}/course/Student/${sessionScope.get("Student").getStu_id()}">课程信息查询</a></li>
                <li> <a href="${pageContext.request.contextPath}/grade/Student/${sessionScope.get("Student").getStu_id()}">查询课程成绩</a></li>
                <li> <a href="${pageContext.request.contextPath}/student/toUpdatePwd/${sessionScope.get("Student").getStu_id()}">修改密码</a></li>
        ...
        <div class="col-sm-9 col-sm-offset-3 col-md-10 col-md-offset-2 main">
            ...
            <form class="form-signin" action="${pageContext.request.contextPath}/student/ChangeStudentPwd/${sid}" method="post">
                <h1 class="page-header">修改你的密码</h1>
                <input type="password" name="old_pwd" class="form-control" placeholder="请输入你的原密码" required>
                <input type="password" name="new_pwd" class="form-control" placeholder="请输入你的新密码" required>
                <input type="password" name="new_pwd_check" class="form-control" placeholder="请再次输入你的新密码" required>
