...
<div class="container-fluid">
    <div class="row">
        ...
        <div class="col-sm-9 col-sm-offset-3 col-md-10 col-md-offset-2 main">
            <form class="form-signin" action="${pageContext.request.contextPath}/course/addACourse" method="post">
                <h1 class="page-header">新增课程</h1>
                <input type="text" name="course_id" class="form-control" placeholder="课程号" required>
                <input type="text" name="course_name" class="form-control" placeholder="课程名" required>
                <input type="text" name="credit" class="form-control" placeholder="学分" required>
                <input type="text" name="course_hour" class="form-control" placeholder="学时" required>
