...
<div class="container-fluid">
    <div class="row">
        ...
        <div class="col-sm-9 col-sm-offset-3 col-md-10 col-md-offset-2 main">
            <form class="form-signin" action="${pageContext.request.contextPath}/course/updateACourse" method="post">
                <h1 class="page-header">修改课程</h1>
                <input type="hidden" name="course_id" value="${course.getCourse_id()}">
                课程号<input type="text" class="form-control" value="${course.getCourse_id()}" disabled="disabled" style="background:#CCCCCC">
                课程名<input type="text" name="course_name" class="form-control" placeholder="${course.getCourse_name()}" value="${course.getCourse_name()}" required>
                学分<input type="text" name="credit" class="form-control" placeholder="${course.getCredit()}" value="${course.getCredit()}" required>
                学时<input type="text" name="course_hour" class="form-control" placeholder="${course.getCourse_hour()}" value="${course.getCourse_hour()}" required>
