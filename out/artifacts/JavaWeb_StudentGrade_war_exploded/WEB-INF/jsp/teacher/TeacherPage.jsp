...
<div class="container-fluid">
    <div class="row">
        ...
        <div class="col-sm-9 col-sm-offset-3 col-md-10 col-md-offset-2 main">
            <h1 class="page-header">欢迎你，${sessionScope.get("Teacher").getT_name()}</h1>
            <h2>个人信息:</h2>
            <h3> <span>教师编号:</span>${sessionScope.get("Teacher").getT_id()} </h3>
            <h3> <span>性别:</span>${sessionScope.get("Teacher").getT_gender()} </h3>
            <h3> <span>电话:</span>${sessionScope.get("Teacher").getTelephone()} </h3>
