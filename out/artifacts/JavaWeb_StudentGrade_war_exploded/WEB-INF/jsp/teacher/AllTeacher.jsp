...
<div class="container-fluid">
    <div class="row">
        ...
        <div class="col-sm-9 col-sm-offset-3 col-md-10 col-md-offset-2 main">
            <h1 class="page-header">教师列表 —— 显示所有教师</h1>
            ...
            <div class="table-responsive">
                <table class="table table-striped">
                    ...
                    <tr>
                        ...
                        <th>性别</th>
                        <th>手机</th>
                        <th><a class="btn btn-primary" href="${pageContext.request.contextPath}/teacher/toAddTeacher">新增</a></th>
                    </tr>
                    </thead>
                    <tbody>
                    <c:forEach var="teacher" items="${requestScope.get('list')}">
                        <tr>
                            <td>${teacher.getT_id()}</td>
                            <td>${teacher.getT_name()}</td>
                            <td>${teacher.getT_gender()}</td>
                            <td>${teacher.getTelephone()}</td>
                            <td>
                                <a href="${pageContext.request.contextPath}/teacher/toUpdateTeacher?id=${teacher.getT_id()}">更改</a> |
                                <a href="${pageContext.request.contextPath}/teacher/del/${teacher.getT_id()}">删除</a>
                            </td>
                        </tr>
                    </c:forEach>
                    </tr>
